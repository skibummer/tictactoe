def end_game_check():
    if row0[0] == row0[1] == row0[2] and row0[0] != "⬜️":
        return False
    elif row1[0] == row1[1] == row2[2] and row0[0] != "⬜️":
        return False
    elif row2[0] == row2[1] == row2[2] and row0[0] != "⬜️":
        return False
    elif row0[0] == row1[0] == row2[0] and row0[0] != "⬜️":
        return False
    elif row0[1] == row1[1] == row2[1] and row0[0] != "⬜️":
        return False
    elif row0[2] == row1[2] == row2[2] and row0[0] != "⬜️":
        return False
    elif turns_taken == 9:
        return False
    else:
...
# TODO 4. UI
# TODO 5. add that rows and columns must be "X" or "O" ,not
# TODO
# TODO
